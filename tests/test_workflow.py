...
class WorkflowTest(unittest.TestCase):
    ...
    def _register_all_verifications(self,item_id):
        self.service.register_verification(item_id,{"kind":"recovery","recovery_quantity":12,"handler":"回收班组","external_ref":"REC-1"},"recorder",'operations')
        self.service.register_verification(item_id,{"kind":"shoreline","shoreline_result":"正常","inspected_at":"2026-09-25T08:00:00Z","handler":"岸线组","external_ref":"SH-1"},"recorder",'operations')
        self.service.register_verification(item_id,{"kind":"waste","waste_destination":"危废处理中心A","handed_over":True,"handler":"清运班组","external_ref":"W-1"},"recorder",'operations')
    def test_complete_workflow_and_audit(self):
        ...
        self._register_all_verifications(current["id"])
